...
int rst_cmp_group(const Opm::RestartIO::RstGroup& group1, const Opm::RestartIO::RstGroup& group2) {
    ...
    error_count += compare(group1.name, group1.oil_rate_limit,    group2.oil_rate_limit,    std::string{"Different OIL rate target for group: {}  case1: {}  case2: {}"});
    error_count += compare(group1.name, group1.water_rate_limit,  group2.water_rate_limit,  std::string{"Different WATER rate target for group: {}  case1: {}  case2: {}"});
    error_count += compare(group1.name, group1.gas_rate_limit,    group2.gas_rate_limit,    std::string{"Different GAS rate target for group: {}  case1: {}  case2: {}"});
    error_count += compare(group1.name, group1.liquid_rate_limit, group2.liquid_rate_limit, std::string{"Different LIQUID rate target for group: {}  case1: {}  case2: {}"});

    //error_count += compare(group1.name, group1.water_surface_limit,   group2.water_surface_limit,   std::string{"Different water surface injection target for group: {}  case1: {}  case2: {}"});
    //error_count += compare(group1.name, group1.water_reservoir_limit, group2.water_reservoir_limit, std::string{"Different water reservoir target for group: {}  case1: {}  case2: {}"});
    //error_count += compare(group1.name, group1.water_reinject_limit,  group2.water_reinject_limit,  std::string{"Different water reinject target for group: {}  case1: {}  case2: {}"});
    //error_count += compare(group1.name, group1.water_voidage_limit,   group2.water_voidage_limit,   std::string{"Different water voidage target for group: {}  case1: {}  case2: {}"});

    //error_count += compare(group1.name, group1.gas_surface_limit,   group2.gas_surface_limit,   std::string{"Different gas surface injection target for group: {}  case1: {}  case2: {}"});
    //error_count += compare(group1.name, group1.gas_reservoir_limit, group2.gas_reservoir_limit, std::string{"Different gas reservoir target for group: {}  case1: {}  case2: {}"});
    //error_count += compare(group1.name, group1.gas_reinject_limit,  group2.gas_reinject_limit,  std::string{"Different gas reinject target for group: {}  case1: {}  case2: {}"});
    //error_count += compare(group1.name, group1.gas_voidage_limit,   group2.gas_voidage_limit,   std::string{"Different gas voidage target for group: {}  case1: {}  case2: {}"});
...
int rst_cmp_header(const Opm::RestartIO::RstHeader& header1, const Opm::RestartIO::RstHeader& header2) {
    ...
    error_count += compare("next_timestep1", header1.next_timestep1, header2.next_timestep1, "Different header: {} case1: {}  case2: {}");
    error_count += compare("next_timestep2", header1.next_timestep2, header2.next_timestep2, "Different header: {} case1: {}  case2: {}");
    error_count += compare("max_timestep", header1.max_timestep, header2.max_timestep, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_a", header1.guide_rate_a, header2.guide_rate_a, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_b", header1.guide_rate_b, header2.guide_rate_b, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_c", header1.guide_rate_c, header2.guide_rate_c, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_d", header1.guide_rate_d, header2.guide_rate_d, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_e", header1.guide_rate_e, header2.guide_rate_e, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_f", header1.guide_rate_f, header2.guide_rate_f, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_delay", header1.guide_rate_delay, header2.guide_rate_delay, "Different header: {} case1: {}  case2: {}");
    error_count += compare("guide_rate_damping", header1.guide_rate_damping, header2.guide_rate_damping, "Different header: {} case1: {}  case2: {}");
...
bool rst_cmp(const Opm::RestartIO::RstState& rst1, const Opm::RestartIO::RstState& rst2) {
    ...
    for (std::size_t iw=0; iw < static_cast<std::size_t>(header1.num_wells); iw++) {
        ...
        error_count += rst_cmp_well(well1, well2);
    }
    ...
    printf("header.nigrpz: %d   header.nwgmax: %d   header.niwelz:%d \n", header1.nigrpz, header1.nwgmax, header1.niwelz);
    for (std::size_t ig=0; ig < static_cast<std::size_t>(header1.ngroup); ig++) {
        ...
        error_count += rst_cmp_group(group1, group2);
    }
    printf("\n");
