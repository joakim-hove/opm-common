...
BOOST_AUTO_TEST_CASE(MultisegmentWellTest) {
    ...
    std::unique_ptr<Opm::WellConnections> new_connection_set = std::unique_ptr<Opm::WellConnections>( Opm::newConnectionsWithSegments(compsegs, connection_set, segment_set));
