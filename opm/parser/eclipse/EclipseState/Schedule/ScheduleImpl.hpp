...
*/
#ifndef SCHEDULEIMPL_HPP
#define SCHEDULEIMPL_HPP
...
namespace Opm
{
    ...
    public:
        ...
        explicit ScheduleImpl(std::shared_ptr<const Python>) {}
        ScheduleImpl(const Deck& deck,
        ...
        static ScheduleImpl serializeObject();
        ...
        */
        ...
        bool operator==(const ScheduleImpl& data) const;
        ...
        */
        static bool cmp(const ScheduleImpl& sched1, const ScheduleImpl& sched2, std::size_t report_step);
